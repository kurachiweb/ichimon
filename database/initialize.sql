...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account` (
  ...
  `first_name` VARCHAR(63) NOT NULL COMMENT 'アカウント名：姓',
  `middle_name` VARCHAR(63) NULL COMMENT 'アカウント名：ミドル',
  `last_name` VARCHAR(63) NOT NULL COMMENT 'アカウント名：名',
  ...
  `address` TEXT NULL DEFAULT NULL COMMENT '住所',
  `address_bill` TEXT NULL DEFAULT NULL COMMENT '請求先住所',
...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_session` (
  ...
  `account_id` VARCHAR(31) NOT NULL COMMENT 'トークンが有効なアカウント基本ID',
