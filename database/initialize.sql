...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account` (
  `id` BIGINT UNSIGNED NOT NULL COMMENT 'アカウント基本ID',
...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`survey` (
  ...
  `creator_id` BIGINT UNSIGNED NOT NULL COMMENT 'アンケートを作成したアカウントの基本ID',
  `notice_account_id` BIGINT UNSIGNED NOT NULL COMMENT 'アンケートに関して通知するアカウントの基本ID',
  `created_at` DATETIME NOT NULL COMMENT 'データ作成日時',
  `updated_at` DATETIME NOT NULL COMMENT 'データ更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT 'データ削除日時',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_auth` (
  `id` BIGINT UNSIGNED NOT NULL COMMENT 'アカウント認証ID',
  `account_id` BIGINT UNSIGNED NOT NULL COMMENT '対象のアカウント基本ID',
...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`verify_email_token` (
  ...
  `account_id` BIGINT UNSIGNED NOT NULL COMMENT '認証対象のアカウント基本ID',
  `created_at` DATETIME NOT NULL COMMENT 'データ作成日時',
  `updated_at` DATETIME NOT NULL COMMENT 'データ更新日時',
  `deleted_at` DATETIME NULL DEFAULT NULL COMMENT 'データ削除日時',
  PRIMARY KEY (`token`))
...
CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_session` (
  ...
  `account_id` BIGINT UNSIGNED NOT NULL COMMENT 'トークンが有効なアカウント基本ID',
