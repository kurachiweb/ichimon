...
-- -----------------------------------------------------
-- Table `kurachiweb_ichimondev`.`account_setting_url`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kurachiweb_ichimondev`.`account_setting_url` ;

CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_setting_url` (
  `id` VARCHAR(31) NOT NULL COMMENT 'カテゴリID\n1以上のランダム値\n不変',
  `account_id` VARCHAR(31) NOT NULL COMMENT '対象のアカウント基本ID',
  `url` VARCHAR(1022) NOT NULL COMMENT '公開範囲のURL',
...
-- -----------------------------------------------------
-- Table `kurachiweb_ichimondev`.`account_setting_style`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kurachiweb_ichimondev`.`account_setting_style` ;

CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_setting_style` (
...
-- -----------------------------------------------------
-- Table `kurachiweb_ichimondev`.`account_setting_notification`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kurachiweb_ichimondev`.`account_setting_notification` ;

CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_setting_notification` (
...
-- -----------------------------------------------------
-- Table `kurachiweb_ichimondev`.`account_setting_icon`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kurachiweb_ichimondev`.`account_setting_icon` ;

CREATE TABLE IF NOT EXISTS `kurachiweb_ichimondev`.`account_setting_icon` (
  `id` VARCHAR(31) NOT NULL COMMENT 'アカウントプロフィール画像設定ID',
  `account_id` VARCHAR(31) NOT NULL,
  `icon_url` VARCHAR(255) NOT NULL COMMENT 'プロフィール画像のURL',
